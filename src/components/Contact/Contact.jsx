...
const Contact = () => {
  ...
  const contactInfo = [
    {
      ...
      label: "Email",
      value: "puneeth.sai2803@gmail.com",
      href: "mailto:puneeth.sai2803@gmail.com"
    },
    {
      icon: (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    ...
    },
    {
      ...
      label: "Phone",
      value: "+1 (908) 208-2633",
      href: "tel:+19082082633"
    }
  ];
  ...
  const socialLinks = [
    ...
    {
      name: "LinkedIn",
      url: "https://linkedin.com/in/puneeth-sai-tumbalabeedu",
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className={styles.contactInfo}>
            ...
            <div className={styles.infoList}>
              {contactInfo.map((info) => (
                <a key={info.label} href={info.href} className={styles.infoItem}>
